...
type UserEdges struct {
	...
	PullRequests []*Pulls `json:"pull_requests,omitempty"`
...
func (e UserEdges) PullRequestsOrErr() ([]*Pulls, error) {
	if e.loadedTypes[0] {
...
func (*User) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		switch columns[i] {
		case user.FieldID, user.FieldGithubID, user.FieldBangumiID:
...
// QueryPullRequests queries the "pull_requests" edge of the User entity.
func (_m *User) QueryPullRequests() *PullsQuery {
	return NewUserClient(_m.config).QueryPullRequests(_m)
}
...
func (_m *User) String() string {
	...
	builder.WriteString(fmt.Sprintf("%v", _m.BangumiID))
	builder.WriteByte(')')
