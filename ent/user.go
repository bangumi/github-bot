...
func (u *User) QueryPullRequests() *PullsQuery {
	return NewUserClient(u.config).QueryPullRequests(u)
}
...
func (u *User) String() string {
	...
	builder.WriteString(fmt.Sprintf("%v", u.BangumiID))
	builder.WriteByte(')')
