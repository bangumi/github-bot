...
func (_q *UserQuery) QueryPullRequests() *PullsQuery {
	query := (&PullsClient{config: _q.config}).Query()
...
func (_q *UserQuery) WithPullRequests(opts ...func(*PullsQuery)) *UserQuery {
	query := (&PullsClient{config: _q.config}).Query()
...
func (_q *UserQuery) loadPullRequests(ctx context.Context, query *PullsQuery, nodes []*User, init func(*User), assign func(*User, *Pulls)) error {
