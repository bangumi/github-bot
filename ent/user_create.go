...
func (_c *UserCreate) SetBangumiID(v int64) *UserCreate {
	_c.mutation.SetBangumiID(v)
	return _c
}

// SetNillableBangumiID sets the "bangumi_id" field if the given value is not nil.
func (_c *UserCreate) SetNillableBangumiID(v *int64) *UserCreate {
	if v != nil {
		_c.SetBangumiID(*v)
	}
	return _c
...
func (_c *UserCreate) AddPullRequestIDs(ids ...int) *UserCreate {
	_c.mutation.AddPullRequestIDs(ids...)
	return _c
}

// AddPullRequests adds the "pull_requests" edges to the Pulls entity.
func (_c *UserCreate) AddPullRequests(v ...*Pulls) *UserCreate {
	ids := make([]int, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
func (_c *UserCreate) check() error {
	...
	if v, ok := _c.mutation.GithubID(); ok {
	...
	if v, ok := _c.mutation.BangumiID(); ok {
